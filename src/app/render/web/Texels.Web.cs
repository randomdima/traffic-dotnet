...
/// browser did that at boot, and this reads the result out.
/// </summary>
/// <remarks>
/// <para>
...
/// <see cref="Main.Data"/> makes every sheet's bitmap at boot, where waiting is allowed, and this reads
/// one out where the packer stands. The browser holds the bitmaps in its own memory in the meantime,
/// not in this heap.
/// </para>
/// <para>
/// <b>So a sheet the boot did not decode is a fault and not a fetch.</b> There is no way back to an
