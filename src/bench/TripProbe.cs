...
internal static class TripProbe
{
    ...
    public static void Run(SimConfig config)
    {
        ...
        Console.WriteLine(
            ...
            $"{"entered",9}{"full",6}{"given up",10}{"dead",6}{"wrecked",9}");
        ...
        foreach (var map in ProjectPaths.ShippedMaps())
        {
            ...
            Console.WriteLine(
                ...
                $"{sample.DoorsFoundFull,6}{sample.TripsGivenUp,10}{sample.Dead,6}{sample.Wrecked,9}");
        }
    ...
    public static TripSample Sample(string map, SimConfig config)
    {
        ...
        return new TripSample(
            ...
            world.BuildingsEntered - entered, world.DoorsFoundFull - full, world.TripsGivenUp - givenUp, dead, wrecked);
    }
}
