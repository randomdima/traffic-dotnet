...
**`Sb` — the state it delivers.** The old place back on the market, a new one reserved, the route in hand
...
the town — then claim, then replan.

**Guards.** None.

**Bounds.** The claim itself: a car that can claim none keeps driving rather than standing in a lane, and
...
| | Successor |
|---|---|
| the new place is claimed | `P-4` |
| there is nowhere to claim | the next rung of the ladder |

**Why the route is checked before the claim.** A bay claimed without a route to its approach lane is the
same jam again with a different postcode.

**Why the whole entry is one tick.** The manoeuvre *is* the claim. It is still an entry rather than a
